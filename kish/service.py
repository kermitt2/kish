...
def get_app(server_config) -> FastAPI:
    ...
    async def startup_message() -> None:
        ...
        from kish.utils_db import create_user, test_init, create_preferences, test_export, test_labeling_init, test_document_test_init, test_document_init, test_sandbox_init
        import asyncio
